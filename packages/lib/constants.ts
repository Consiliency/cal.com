...
export const IS_TEAM_BILLING_ENABLED = IS_STRIPE_ENABLED && (HOSTED_CAL_FEATURES || IS_SELF_HOSTED);

export const IS_TEAM_BILLING_ENABLED_CLIENT =
  !!process.env.NEXT_PUBLIC_STRIPE_PUBLIC_KEY && (HOSTED_CAL_FEATURES || IS_SELF_HOSTED);
